...
- [x] Replace Full Body C Dumbbell Romanian Deadlift with a revision-safe Standing Single-Leg Cable Hamstring Curl, preserving historical RDL data and using independent calibration/progression
