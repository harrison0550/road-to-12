...
assert.match(app, /compatibleRevisions=\[LEGACY_FOUNDATION_PROGRAM_REVISION,PREVIOUS_FOUNDATION_PROGRAM_REVISION,GMWD_FOUNDATION_PROGRAM_REVISION,CONCENTRATION_FOUNDATION_PROGRAM_REVISION,FOUNDATION_PROGRAM_REVISION\]/, "active workout revision compatibility must remain explicit");
assert.match(app, /programRevision:sessionPhaseId==="build"\?window\.ROAD12_BUILD\.VERSION:FOUNDATION_PROGRAM_REVISION/, "new sessions must capture the correct versioned Foundation or Build program boundary");
